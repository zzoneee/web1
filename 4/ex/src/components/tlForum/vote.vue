            ...
            <el-row :gutter="0">
                <el-col :span="5" class="left_area">
                    ...
                    <div class="list_ex lst1">
                        <div @click="ex1_click">
                            <div class="ex_name" :class="{'color_click':exNo==1}">我的投票活动</div>
                        </div>
                        <div @click="ex2_click">
                            <div class="ex_name" :class="{'color_click':exNo==2}">所有投票活动</div>
                        </div>
                    </div>
...
<script>
    const voteMine = () => import('./voteMine');
    const voteAll = () => import('./voteAll');
    export default {
        components:{
            "step1":voteMine,
            "step2":voteAll,
